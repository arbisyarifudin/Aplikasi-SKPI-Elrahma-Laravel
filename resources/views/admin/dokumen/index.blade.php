                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ $d->file_url }}" target="_blank"
                                        class="btn btn-sm btn-light preview-pdf" data-bs-toggle="modal"
                                ...
                                <td>{{ $d->dibuat_pada }}</td>
                                <td>
                                    {{-- <a title="Detail" href="#" class="btn btn-sm btn-light"><i
                                    ...
                                    {{-- <a title="Ubah" href="{{ route('admin.dokumen.edit', ['id' => $d->id]) }}"
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        setInterval(() => {
            // check apakah ada modal yang muncul
