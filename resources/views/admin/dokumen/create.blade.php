			...
			<div class="card overflow-auto">
				<div class="card-body" style="min-height: 300px">
					<div class="card-title d-flex justify-content-between">
						<a href="{{ getBackUrl() }}" class="btn btn-sm btn-outline-primary"><i class="bi bi-arrow-left"></i> Kembali</a>
					...
					<form action="{{ route('admin.dokumen.store') }}" method="post">
						...
						<div class="row">
							<div class="col-md-6 d-none">
								<div class="mb-3">
									...
									<input type="text" name="dokumen_nomor" id="dokumen_nomor" class="form-control @error('dokumen_nomor') is-invalid @enderror" value="{{ $noDokumen }}" disabled placeholder="Nomor dokumen">
									@error('dokumen_nomor')
							...
							<div class="col-md-6 d-none">
								<div class="mb-3">
									...
									<input type="date" name="dokumen_tanggal" id="dokumen_tanggal" class="form-control @error('dokumen_tanggal') is-invalid @enderror" value="{{ old('dokumen_tanggal', date('Y-m-d')) }}" placeholder="Tgl. Dokumen">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									<select name="jenjang_id" id="jenjang_id" class="form-select @error('jenjang_id') is-invalid @enderror" v-model="selectedJenjang" @change="getProdiData">
							...
							<div class="col-md-6" v-if="selectedJenjang">
								<div class="mb-3">
									...
									<select name="program_studi_id" id="program_studi_id" class="form-select @error('program_studi_id') is-invalid @enderror" v-model="selectedProdi" @change="getMahasiswaData">
						...
						<div class="row">
							<div class="col-md-6" v-if="selectedProdi">
								<div class="mb-3">
									<div :class="loadingMahasiswa ? 'mb-2' : 'mb-1'">Mahasiswa <span class="text-danger">*</span></div>
									<div class="row">
										<div class="col-md-12">
											<div class="d-flex justify-content-start mb-2">
												<div class="spinner-border spinner-border-sm text-primary" role="status" v-if="loadingMahasiswa">
												...
												<div class="form-check" v-if="!checkAllMahasiswa && mahasiswaData.length">
													<input class="form-check-input" type="checkbox" value="" name="semua_mahasiswa" id="semua_mahasiswa" v-model="checkAllMahasiswa">
													<label class="form-check-label" for="semua_mahasiswa">
														Pilih Semua
													</label>
												</div>
												<button v-if="selectedMahasiswa.length" type="button" class="btn btn-sm btn-outline-primary ms-2 p-1 py-0" @click="selectedMahasiswa = []">
											...
											<div class="mb-3">
												...
												<div class="mt-2 p-2" style="border: 1px solid #ddd">
													<div v-for="item in mahasiswaData" :key="item.id" class="form-check">
														<input class="form-check-input" type="checkbox" :id="'mahasiswa_' + item.id" :name="'mahasiswa_ids[]'" :value="item.id" v-model="selectedMahasiswa">
														<label class="form-check-label" :for="'mahasiswa_' + item.id">
															@{{ item.nama }} (@{{ item.nim }}) <span v-if="item.is_have_skpi" class="badge bg-success">Sudah
																dibuat</span>
														</label>
													</div>
							...
							<div class="col-md-12" v-if="!!pengaturanHasilCapaianData && !!selectedProdi">
								<div class="mb-2">
									<div>
										...
										<!-- <button style="font-size: 0.8rem; padding: 0.2rem 0.35rem; line-height: 1rem;" type="button" class="ms-2 btn btn-sm btn-outline-primary" @click="pengaturanHasilCapaianInEditMode = !pengaturanHasilCapaianInEditMode">
											<i class="bi bi-pencil"></i>
										</button> -->
										<button style="font-size: 0.8rem; padding: 0.2rem 0.35rem; line-height: 1rem;" type="button" class="ms-2 btn btn-sm btn-outline-primary" @click="openEditCplPage">
											<i class="bi bi-pencil"></i>
										</button>
									</div>
								</div>
                        ...
                        <textarea name="cpl" :value="pengaturanHasilCapaianDataStringify" style="display: none;"></textarea>
