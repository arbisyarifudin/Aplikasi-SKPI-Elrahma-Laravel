...
@section('title', 'Ubah Prestasi Mahasiswa - ')

@section('content')
<div class="pagetitle">
    <h1>Ubah Prestasi Mahasiswa</h1>
    <nav>
        <ol class="breadcrumb">
            ...
            <div class="card overflow-auto">
                <div class="card-body" style="min-height: 300px">
                    <div class="card-title d-flex justify-content-between">
                        <a href="{{ route('admin.mahasiswa.show', ['id' => $prestasi->id]) }}" class="btn btn-sm btn-outline-primary"><i
                    ...
                    <form action="{{ route('admin.mahasiswa.prestasi.update', ['mahasiswaId' => $mahasiswa->id, 'prestasiId' => $prestasi->id]) }}" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            @endif
                            <div>
                                <input type="radio" id="fileOption" name="tipe_sertifikat" value="file" {{
                                    old('tipe_sertifikat', $tipe_sertifikat)=='file' ? 'checked' : '' }}>
                                <label for="fileOption">File</label>
                                <input type="radio" id="urlOption" name="tipe_sertifikat" value="url" {{
                                    old('tipe_sertifikat', $tipe_sertifikat) =='url' ? 'checked' : '' }}>
                                <label for="urlOption">URL</label>
                            </div>
                            <div id="fileInput" class="mt-2"
                                style="{{ old('tipe_sertifikat', $tipe_sertifikat) == 'file' ? 'display: block;' : 'display: none;' }}">
